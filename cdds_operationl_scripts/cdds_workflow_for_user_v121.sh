...
export CDDS_DIR="/home/users/valeriu/cdds_example_FAF"  # runtime files
...
ENV_FILE=/gws/smf/j04/cmip6_prep/cdds-env/setup_cdds_env.sh
source $ENV_FILE
...
# NOTE could add -m $MIP but this is suggested not to be used as per https://github.com/cedadev/jasmin-cdds/issues/34
